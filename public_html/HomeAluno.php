...
<body>
    <div id="app" class="d-flex vh-100">
        <section class="col-2 h-100 bg-dark d-none d-lg-block ">
            <?php
            include "../app/view/homeAluno/navBarLateral.php";
            ?>
        </section>
        <section id="content" class="col-lg-10 col-12 vh-100 bg-light p-0 " style="background-color: #ecf0f5 !important">
            <div id="Turmas" class="col-12 h-100 p-0 d-none overflow-auto" style="background-color: #ecf0f5 !important">
                <?php
                include "../app/view/homeAluno/turmas.php";
                ?>
            </div>
